...
export const MCP_TOOLS = [
  ...
  },
  {
    ...
    inputSchema: { type: 'object', properties: { scope, manifest: { type: 'string', description: 'Path to a scope-remediation-manifest v1 or v3 document.' }, confirm }, required: ['manifest'], additionalProperties: false },
    annotations: { destructiveHint: true, idempotentHint: true },
  },
  {
