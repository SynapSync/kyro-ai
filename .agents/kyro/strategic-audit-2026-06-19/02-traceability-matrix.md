...
| Audit theme | Current status | Backlog file | Task IDs |
|-------------|----------------|--------------|----------|
| Reproducibility and CI | DONE: `dist` freshness, adapter CI, release gates, and generated artifact docs are in place | `00-p0-reproducibility-and-ci.md` | REP-001, REP-002, REP-003, REP-004, REP-005 |
| Token and cost optimization | PARTIAL: eager runtime is slim and audited; context-pack generation and model routing remain pending | `01-token-cost-optimization.md` | TCO-001, TCO-002, TCO-003, TCO-004, TCO-005, TCO-006 |
...
| Metrics/instrumentation | PARTIAL: compact `events.ndjson` schema/validation exists; writer and reports remain pending | `07-metrics-observability.md` | OBS-001, OBS-002, OBS-003, OBS-004, OBS-005 |
